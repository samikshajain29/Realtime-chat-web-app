...
function Login() {
  ...
  return (
    <div className="w-full h-screen bg-slate-50 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full blob-teal filter blur-[100px] opacity-80 animate-pulse"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full blob-sky filter blur-[100px] opacity-80 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="w-full max-w-[440px] glass-card rounded-3xl flex flex-col overflow-hidden relative z-10 p-8 border border-white/60">
        <div className="w-full pb-8 flex flex-col items-center justify-center relative">
          ...
          <p className="text-slate-500 mt-2 text-sm">Login to your <span className="text-teal-600 font-semibold">Chatify</span> account</p>
        </div>
