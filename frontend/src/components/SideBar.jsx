...
function SideBar() {
  ...
  return (
    ...
    >
      ...
      {input.length > 0 && (
        <div className="flex w-full h-[500px] overflow-y-auto items-center pt-[20px] flex-col gap-[10px] absolute top-[250px] bg-[white] z-[150] shadow-lg">
          {searchData?.map((user) => (
            <div
              className="w-[95%] h-[70px] flex items-center gap-[20px] bg-white px-[10px] hover:bg-[#78cae5] border-b-2 border-gray-400 cursor-pointer"
              onClick={() => {
      ...
      <div className="w-full h-[300px] bg-[#20c7ff] rounded-b-[30%] shadow-gray-400 shadow-lg flex flex-col  justify-center px-[20px]">
        ...
        <div className="w-full flex items-center gap-[20px] overflow-y-auto py-[18px]">
          ...
          {search && (
            <form className="w-full h-[60px] bg-white shadow-gray-500 shadow-lg flex items-center gap-[10px] mt-[10px] rounded-full overflow-hidden px-[20px] cursor-pointer relative">
              <IoIosSearch className="w-[25px] h-[25px]" />
              <input
                type="text"
